...
const getPromos = (queryParams, url) => {
  return new Promise((resolve, reject) => {
    let query =
      "select promos.id, promos.code, promos.discount, p.id ,p.product_name, p.image, promos.created_at, promos.updated_at, promos.description, promos.expiry_date, promos.start_active_date from promos join products p on promos.product_id = p.id order by promos.id asc";
